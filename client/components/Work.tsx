...
const Work: FunctionComponent = () => {
  return (
    <>
      <div className="work-overall-container">
        ...
        <div className="work-container" data-aos="fade-up">
          <div className="recoilize-project">
            ...
            <p className="work-discription">
              ...
              state management library. It allows users to log state changes,
              time travel back to previous state, and visualize recoil-based
              applications. The tool analyzes the relationships of Recoil's
              Atoms and Selectors which are displayed through visualizations and
              also provides information about component render times.
            </p>
          ...
          <div className="hideAndSecret">
            ...
            <p className="work-discription">
              ...
              able to create, drop, and pick up secrets in the real world
              wherever they are currently located at. Utilizing google maps, you
              are able to visually see and pick up new secrets around you. You
              are able to compare yourself to the world with a global leadership
              board as well as see the stash of secrets you managed to collect.
            </p>
            <p className="web-link-p">
              (
              <a
